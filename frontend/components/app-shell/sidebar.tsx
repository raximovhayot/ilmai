          ...
          <UserMenu
            ...
            trigger={
              <Button
                variant="ghost"
                className={cn(
                  "h-auto w-full justify-start gap-2.5 rounded-xl px-2.5 py-2 text-start hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
                  collapsed && "lg:justify-center lg:px-0"
                )}
...
function SidebarItem({
  ...
  const link = (
    <Link
      ...
      className={cn(
        "group/item relative flex items-center gap-2.5 rounded-xl px-2.5 py-2 text-sm font-medium transition-colors",
        active
          ? "bg-sidebar-accent text-sidebar-accent-foreground"
          : "text-sidebar-foreground/80 hover:bg-sidebar-accent/60 hover:text-sidebar-accent-foreground",
        collapsed && "lg:justify-center lg:px-0"
    ...
    >
      {active && (
        <span
          aria-hidden
          className={cn(
            "absolute start-0 top-1/2 h-5 w-1 -translate-y-1/2 rounded-full bg-primary",
            collapsed && "lg:hidden"
          )}
        />
      )}
