...
public class ChatMemorySummary extends DateAuditable {
    ...
    @Column(name = "folded_messages", nullable = false)
    private int foldedMessages;
    ...
    public final boolean equals(Object o) {
        ...
        ChatMemorySummary other = (ChatMemorySummary) o;
